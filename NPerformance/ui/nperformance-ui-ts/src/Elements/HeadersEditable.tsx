...
interface HeadersEditableProps {
    header: IHeader;
    key: string;
    index: number;
    delete : Function;
...
export default function HeadersEditable(props: HeadersEditableProps) {
    console.log(props);
    ...
    const handleHeaderChange = (event: ChangeEvent<HTMLSelectElement>) => {
